...
```
Task(
  prompt="Read C:/Users/super/Documents/finance-manager-glm/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/super/Documents/finance-manager-glm/.claude/get-shit-done/templates/VALIDATION.md`
