...
```bash
INIT=$(node "C:/Users/super/Documents/finance-manager-glm/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/super/Documents/finance-manager-glm/.claude/get-shit-done/templates/spec.md.
